		...
		<?php if( get_field('estabelecimento') ): ?>
			...
			<?php else: ?>
				<div class="col s12 m6 l4 center margin-categorias" id="nao-encontrado">
		    		<p style="padding:30px;">Nenhum conteúdo encontrado nesta categoria. Volte para a <a href="/">Página Inicial</a> ou utilize os filtros acima para refazer a busca.</p>
		    	</div>
		    <?php endif; ?>
		<?php endwhile; ?>
	</div>
