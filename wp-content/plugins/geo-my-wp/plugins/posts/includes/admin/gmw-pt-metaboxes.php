...
class GMW_PT_Meta_Boxes {
    ...
    function display_meta_box() {
		...
		<div class="gmw-location-section map">
			<h2 class="hndle ui-sortable-handle" style="font-weight: bold">
				<?php _e( 'Use o mapa para encontrar a localização da empresa:','GMW' );?>
			</h2>
			<div id="map"></div>
		</div>
		...
		<div class="clear"></div>
            ...
            <div class="gmw-location-section gmw-location-manually-wrapper" style="display: none">
            ...
            <div class="gmw-location-section additional-information-wrapper" style="display: none">
